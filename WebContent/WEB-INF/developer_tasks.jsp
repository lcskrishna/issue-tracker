...
<div id="nav-bar">
	...
	<table id="developer-tasks-table">
		...
		<c:forEach items="${tasks}" var="listValue">
			<tr>
				<form:form method="POST" action="/issue-tracker/task/updateStatus">

					<td align="center"><form:input path="taskId" required="true"
							value="${listValue.taskId }" /></td>

					<td align="center"><form:input path="taskName" required="true"
							value="${listValue.taskName }" /></td>

					<td align="center"><form:input path="taskName" required="true"
							value="${listValue.taskType }" /></td>

					<td align="center"><form:input path="taskCreatedBy"
							required="true" value="${listValue.taskCreatedBy }" /></td>

					<td align="center"><form:input path="taskAssignedTo"
							required="true" value="${listValue.taskAssignedTo }" /></td>

					<td align="center"><form:input path="status" required="true"
							value="${listValue.status }" /></td>

					<td align="center"><input class="btn" type="submit" value="Update Status" />
					</td>

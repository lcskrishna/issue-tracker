...
<body>
	<div id="developer-home-container">
		<div id="nav-bar">
			...
			<table id="issues_table">
				<tr>
					<form:form method="POST"
						action="/issue-tracker/task/viewAssignedTasks/${user }">

						<td id="assigned-tasks">
							<h3>Click here to view all assigned tasks.</h3> <img
							src="assigned_tasks.jpg" alt="Assigned Tasks" height=50 width=50 />

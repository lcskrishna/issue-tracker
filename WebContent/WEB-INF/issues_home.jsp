...
<body>
	<div id="issues_home">
		...
		<table id="issues_table">
			...
			<c:forEach items="${issues}" var="listValue">
				<tr>
					<form:form method="POST" action="/issue-tracker/task/updateStatus">
						...
						<td align="center"><form:input path="taskName"
								required="true" value="${listValue.taskName }" /></td>

						<td align="center"><form:input path="taskName"
								required="true" value="${listValue.taskType }" /></td>
						...
						<td align="center"><input class="btn" type="submit"
